...
test(
  'Avatar image exists',
  (indexHtml.includes('images/hero/avatar.jpg') ||
    indexHtml.includes('images/hero/avatar.svg')) &&
    indexHtml.includes('alt='),
...
const projectsSectionJs = fs.readFileSync(
  'js/components/ProjectsSection.js',
  'utf8'
);

test(
  'Projects data file exists',
  fs.existsSync('js/data/projects.js'),
  'Found js/data/projects.js'
);

test(
  'Sample projects defined',
...
test(
  'Project initialization in main.js',
